      ...
      <div className="relative min-h-screen text-white">
        ...
        <section className="relative min-h-screen px-6 pb-20 pt-32">
          <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-7xl items-center">
            <div className="grid w-full gap-14 lg:grid-cols-[minmax(0,1.08fr)_minmax(360px,0.92fr)] lg:items-center">
              <div className="max-w-3xl">
                <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-xs font-medium uppercase tracking-[0.22em] text-white/55 backdrop-blur">
                  <span className="h-2 w-2 rounded-full bg-cyan-400 shadow-[0_0_12px_rgba(34,211,238,0.9)]" />
                  AI Operating System
                </div>

                <h1 className="max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-0.04em] text-white md:text-6xl lg:text-7xl">
                  Run your company with
                  <span className="bg-gradient-to-r from-cyan-400 via-violet-400 to-pink-400 bg-clip-text text-transparent"> AI agents </span>
                  that stay aligned.
                </h1>

                <p className="mt-6 max-w-2xl text-lg leading-8 text-white/62 md:text-xl">
                  Orkestria gives you one place to manage leads, automate outreach and coordinate agents without the noise of a complicated stack.
                </p>

                <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                  <Link
                    href="/register"
                    className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-7 py-4 text-sm font-semibold text-[#050b14] transition-transform duration-200 hover:-translate-y-0.5"
                  >
                    Start free
                  ...
                  <Link
                    href="/login"
                    className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/12 bg-white/[0.03] px-7 py-4 text-sm font-medium text-white/82 transition-colors hover:border-white/20 hover:bg-white/[0.06]"
                  >
                    Sign in
                  </Link>
                </div>
                ...
                <div className="mt-12 grid max-w-2xl gap-4 sm:grid-cols-3">
                  {[
                    "Leads and outreach in one flow",
                    "AI squads with clear roles",
                    "Real-time visibility for every operation",
                  ].map((item) => (
                    <div
                      key={item}
                      className="rounded-2xl border border-white/8 bg-white/[0.03] px-4 py-4 text-sm text-white/62 backdrop-blur"
                    >
              ...
              <div className="relative">
                <div className="absolute inset-x-10 top-0 h-40 rounded-full bg-cyan-500/10 blur-3xl" />
                <div className="absolute -bottom-4 right-6 h-44 w-44 rounded-full bg-violet-500/14 blur-3xl" />

                <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(13,22,34,0.95),rgba(8,14,23,0.92))] p-6 shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur-xl md:p-7">
                  <div className="mb-6 flex items-center justify-between border-b border-white/8 pb-5">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-[0.24em] text-white/45">Control center</p>
                      <h2 className="mt-2 text-2xl font-semibold text-white">Keep your operation focused</h2>
                    </div>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-3xl border border-white/8 bg-white/[0.03] p-5">
                      ...
                      <p className="mt-3 text-3xl font-semibold text-white">284</p>
                      <p className="mt-1 text-sm text-emerald-300">Qualified leads this week</p>
                    </div>
                    <div className="rounded-3xl border border-white/8 bg-white/[0.03] p-5">
                      ...
                      <p className="mt-1 text-sm text-cyan-300">Automated emails in motion</p>
                    </div>
                  </div>

                  <div className="mt-5 space-y-3">
                    {[
                      { title: "Lead discovery", note: "Finding and enriching high-fit accounts" },
                      { title: "Qualification", note: "Prioritizing who deserves attention now" },
                      { title: "Follow-up", note: "Running outreach sequences with context" },
                    ].map((item, index) => (
                      <div
                        key={item.title}
                        className="flex items-center justify-between rounded-2xl border border-white/8 bg-white/[0.025] px-4 py-4"
                      >
                        <div className="flex items-center gap-3">
                          <div className={`flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br ${agentTypes[index]?.color ?? "from-cyan-500 to-blue-500"}`}>
                            {(() => {
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#030810] to-transparent" />
        </section>
