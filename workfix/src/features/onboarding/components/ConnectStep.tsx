 ...
 */
import { CheckCircle2, Loader2, ServerCog, Wifi, WifiOff } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-md border border-white/10 bg-white/5 px-3 py-3 text-[11px] text-white/75">
          <div className="flex items-center gap-2 font-medium text-white/85">
            <ServerCog className="h-3.5 w-3.5 text-emerald-300" />
            Token do gateway via backend
          </div>
          <p className="mt-1 text-white/55">O Okestria envia o token no servidor. Informe apenas a URL do gateway.</p>
        </div>
