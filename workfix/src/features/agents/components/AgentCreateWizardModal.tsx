...
const AGENT_WIZARD_TEMPLATES: Array<{
  ...
  name: string;
  summary: string;
  draft: Partial<PersonalityBuilderDraft>;
}> = [
  {
...
const mergeImportedDraft = (
  ...
  incoming: Partial<PersonalityBuilderDraft>,
...
export function AgentCreateWizardModal({
  ...
  const applyTemplateDraft = (incoming: Partial<PersonalityBuilderDraft>, sourceLabel: string) => {
