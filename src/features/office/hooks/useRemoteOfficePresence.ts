...
export const useRemoteOfficePresence = ({
    ...
    const loadFromGateway = async () => {
      ...
      try {
        ...
        const nextSnapshot = buildOfficePresenceSnapshotFromGateway({
          agentsResult: {
            ...agentsResult,
            agents: Array.isArray(agentsResult.agents)
  ...
  }, [active, allowedAgentIdSet, allowedAgentIds, normalizedGatewayUrl, pollIntervalMs, presenceUrl, requestUrl, sourceKind]);
