  ...
  return (
    <div className="fade-up-delay flex flex-col gap-3">
      ...
      <div className="grid gap-3 lg:grid-cols-[1.4fr_1fr]">
        ...
        <div className="flex flex-col gap-1 font-mono text-[10px] font-semibold tracking-[0.06em] text-muted-foreground">
          Token do gateway
          <div className="ui-input flex h-10 items-center gap-2 rounded-md px-4 font-sans text-sm text-foreground/80">
            <ServerCog className="h-4 w-4 text-cyan-300" />
            <span>Enviado automaticamente pelo backend</span>
          </div>
        </div>
      </div>
      {error ? (
