  ...
  return (
    ...
    >
      <group position={[widthWorld / 2, 0, depthWorld / 2]} rotation={[0, rotY, 0]}>
        ...
        {/* v46: The previous PTX monogram/brass disc/gold ring at the
         * center of the table have been removed per user request —
         * the top is now a completely clean polished walnut surface. */}
      </group>
    </group>
  );
}
...
// allocate dozens of BufferGeometry objects for every couch/beanbag/tv.
// Many of these are re-used across multiple lounge components to keep the
// GPU vertex/material budget low for a smooth 60fps.
// (v46: Arcade cabinet removed from the project — its shared button
// geometries/materials were deleted alongside the model.)
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// (v46) ArcadeModel was removed from the project per user request.
// The component, its shared geometries, and its layout entries are all gone.
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
...
// (v46) ArcadeModel removed from the project.
