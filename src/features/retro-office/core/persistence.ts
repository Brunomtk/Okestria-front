import {
  ART_ROOM_REMOVAL_MIGRATION_KEY,
  ATM_MIGRATION_KEY,
...
export const hasArtRoomRemovalMigrationApplied = (namespace = "default") =>
  hasStorageFlag(ART_ROOM_REMOVAL_MIGRATION_KEY, namespace);

export const markArtRoomRemovalMigrationApplied = (namespace = "default") => {
  markStorageFlag(ART_ROOM_REMOVAL_MIGRATION_KEY, namespace);
};
