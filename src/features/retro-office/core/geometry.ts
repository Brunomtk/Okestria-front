...
export const ITEM_FOOTPRINT: Record<string, [number, number]> = {
  ...
  exercise_bike: [45, 65],
  squat_rack: [48, 48],
  deadlift_platform: [150, 80],
  plate_rack: [40, 30],
  cable_crossover: [100, 70],
  punching_bag: [28, 28],
  jukebox: [60, 40],
  ...
  locker: [40, 40],
  copier: [40, 30],
  reception_desk: [120, 40],
  side_table: [30, 30],
  ottoman: [28, 28],
  bench_seat: [80, 24],
  coat_rack: [18, 18],
  floor_sign: [18, 18],
  router_station: [24, 16],
  speaker: [20, 20],
  projector: [24, 18],
  tv_stand: [80, 24],
  charging_station: [24, 24],
  arcade: [30, 30],
  foosball: [90, 50],
  air_hockey: [100, 60],
  podium: [26, 20],
...
export const ITEM_METADATA: Record<string, { blocksNavigation: boolean }> = {
  // ── structural ────────────────────────────────────────────────────────────
  wall:            { blocksNavigation: false }, // interior gray walls are now pass-through; canvas bounds still block
  ...
  // ── QA lab ────────────────────────────────────────────────────────────────
  qa_terminal:     { blocksNavigation: false },
  device_rack:     { blocksNavigation: false },
  test_bench:      { blocksNavigation: false },
  // ── gym ───────────────────────────────────────────────────────────────────
  treadmill:       { blocksNavigation: false },
  weight_bench:    { blocksNavigation: false },
  dumbbell_rack:   { blocksNavigation: false },
  exercise_bike:   { blocksNavigation: false },
  squat_rack:      { blocksNavigation: true  },
  deadlift_platform:{ blocksNavigation: false },
  plate_rack:      { blocksNavigation: true  },
  cable_crossover: { blocksNavigation: true  },
  punching_bag:    { blocksNavigation: false },
  jukebox:         { blocksNavigation: true  },
  rowing_machine:  { blocksNavigation: false },
  kettlebell_rack: { blocksNavigation: false },
  yoga_mat:        { blocksNavigation: false },
  // ── art room ──────────────────────────────────────────────────────────────
  ...
  locker:          { blocksNavigation: true  },
  copier:          { blocksNavigation: true  },
  reception_desk:  { blocksNavigation: true  },
  side_table:      { blocksNavigation: true  },
  ottoman:         { blocksNavigation: true  },
  bench_seat:      { blocksNavigation: true  },
  coat_rack:       { blocksNavigation: false },
  floor_sign:      { blocksNavigation: false },
  router_station:  { blocksNavigation: false },
  speaker:         { blocksNavigation: false },
  projector:       { blocksNavigation: false },
  tv_stand:        { blocksNavigation: true  },
  charging_station:{ blocksNavigation: false },
  arcade:          { blocksNavigation: true  },
  foosball:        { blocksNavigation: true  },
  air_hockey:      { blocksNavigation: true  },
  podium:          { blocksNavigation: true  },
  camera_tripod:   { blocksNavigation: false },
  mail_cart:       { blocksNavigation: true  },
  first_aid:       { blocksNavigation: false },
};
