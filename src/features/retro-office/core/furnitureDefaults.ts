...
// SERVER ROOM v37 — east wall ALIGNED with the meeting room east wall (cx=315 · cy=560..720).
// Door repositioned so its 40-unit rotated bounds sit EXACTLY in the 40-unit wall gap
// (gap cy=620..660 → door item.y must be 636 so center=640 and rotated bounds=620..660).
...
const DEFAULT_FURNITURE: FurnitureSeed[] = [
  ...
  // === OPEN-OFFICE DESKS v37 — 3 rows × 4 desks, aligned with user template: ===
  //   Chair = (desk.x + 50, desk.y + 60) facing 180 → sits BELOW desk, person faces north.
  //   Computer = (desk.x + 50, desk.y + 20) → top portion of desk surface.
  //   Keyboard = (desk.x + 35, desk.y + 40), Mouse = (desk.x + 70, desk.y + 42),
  //   Trash = (desk.x + 5, desk.y + 35).
  // Row 1 (desks at y=150) — ATM clears at cx=372 so desks start at cx=400
  { type: "desk_cubicle", x: 400, y: 150, id: "desk_0", facing: 180 },
  { type: "chair", x: 450, y: 210, facing: 180 },
  { type: "computer", x: 450, y: 170 },
  { type: "keyboard", x: 435, y: 190 },
  { type: "mouse", x: 470, y: 192 },
  { type: "trash", x: 405, y: 185 },
  { type: "desk_cubicle", x: 560, y: 150, id: "desk_1", facing: 180 },
  { type: "chair", x: 610, y: 210, facing: 180 },
  { type: "computer", x: 610, y: 170 },
  { type: "keyboard", x: 595, y: 190 },
  { type: "mouse", x: 630, y: 192 },
  { type: "trash", x: 565, y: 185 },
  { type: "desk_cubicle", x: 720, y: 150, id: "desk_2", facing: 180 },
  { type: "chair", x: 770, y: 210, facing: 180 },
  { type: "computer", x: 770, y: 170 },
  { type: "keyboard", x: 755, y: 190 },
  { type: "mouse", x: 790, y: 192 },
  { type: "trash", x: 725, y: 185 },
  { type: "desk_cubicle", x: 880, y: 150, id: "desk_3", facing: 180 },
  { type: "chair", x: 930, y: 210, facing: 180 },
  { type: "computer", x: 930, y: 170 },
  { type: "keyboard", x: 915, y: 190 },
  { type: "mouse", x: 950, y: 192 },
  { type: "trash", x: 885, y: 185 },

  // Row 2 (desks at y=310)
  { type: "desk_cubicle", x: 400, y: 310, id: "desk_4", facing: 180 },
  { type: "chair", x: 450, y: 370, facing: 180 },
  { type: "computer", x: 450, y: 330 },
  { type: "keyboard", x: 435, y: 350 },
  { type: "mouse", x: 470, y: 352 },
  { type: "trash", x: 405, y: 345 },
  { type: "desk_cubicle", x: 560, y: 310, id: "desk_5", facing: 180 },
  { type: "chair", x: 610, y: 370, facing: 180 },
  { type: "computer", x: 610, y: 330 },
  { type: "keyboard", x: 595, y: 350 },
  { type: "mouse", x: 630, y: 352 },
  { type: "trash", x: 565, y: 345 },
  { type: "desk_cubicle", x: 720, y: 310, id: "desk_6", facing: 180 },
  { type: "chair", x: 770, y: 370, facing: 180 },
  { type: "computer", x: 770, y: 330 },
  { type: "keyboard", x: 755, y: 350 },
  { type: "mouse", x: 790, y: 352 },
  { type: "trash", x: 725, y: 345 },
  { type: "desk_cubicle", x: 880, y: 310, id: "desk_7", facing: 180 },
  { type: "chair", x: 930, y: 370, facing: 180 },
  { type: "computer", x: 930, y: 330 },
  { type: "keyboard", x: 915, y: 350 },
  { type: "mouse", x: 950, y: 352 },
  { type: "trash", x: 885, y: 345 },

  // Row 3 (desks at y=470)
  { type: "desk_cubicle", x: 400, y: 470, id: "desk_8", facing: 180 },
  { type: "chair", x: 450, y: 530, facing: 180 },
  { type: "computer", x: 450, y: 490 },
  { type: "keyboard", x: 435, y: 510 },
  { type: "mouse", x: 470, y: 512 },
  { type: "trash", x: 405, y: 505 },
  { type: "desk_cubicle", x: 560, y: 470, id: "desk_9", facing: 180 },
  { type: "chair", x: 610, y: 530, facing: 180 },
  { type: "computer", x: 610, y: 490 },
  { type: "keyboard", x: 595, y: 510 },
  { type: "mouse", x: 630, y: 512 },
  { type: "trash", x: 565, y: 505 },
  { type: "desk_cubicle", x: 720, y: 470, id: "desk_10", facing: 180 },
  { type: "chair", x: 770, y: 530, facing: 180 },
  { type: "computer", x: 770, y: 490 },
  { type: "keyboard", x: 755, y: 510 },
  { type: "mouse", x: 790, y: 512 },
  { type: "trash", x: 725, y: 505 },
  { type: "desk_cubicle", x: 880, y: 470, id: "desk_11", facing: 180 },
  { type: "chair", x: 930, y: 530, facing: 180 },
  { type: "computer", x: 930, y: 490 },
  { type: "keyboard", x: 915, y: 510 },
  { type: "mouse", x: 950, y: 512 },
  { type: "trash", x: 885, y: 505 },

  // === SERVER ROOM v37 (aligned with meeting room east wall — cx=0..315 · cy=560..720) ===
  // East wall runs in the same vertical line as the meeting room east wall (cx=315).
  // Door repositioned to y=636 so its 40-unit rotated bounds fill the cy=620..660 gap exactly.
  { type: "wall", x: 0, y: 560, w: 323, h: 8 },
  { type: "wall", x: 315, y: 560, w: 8, h: 60 },
  { type: "door", x: 299, y: 636, w: 40, h: 8, facing: 90 },
